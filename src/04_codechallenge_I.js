...
/******Meine Lösung*****/
let firstNumber = Number(prompt("Was soll ich addieren?: "));
let seccondNumber = Number(prompt("Deine zweite Zahl?: "));
let summe = firstNumber + seccondNumber
console.log("Hier ist dein Ergebnis: " + summe);
...
//Typkonvertierung 1: ziffer --> zahl (mit Nachkommastellen)
